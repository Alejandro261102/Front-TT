    ...
    <PrivateLayout>
      <main className="contacts-page section">
        <div className="container">
          ...
          <section className="search-section" style={{ marginTop: '2rem', marginBottom: '3rem' }}>
            <div className="auth-card" style={{ padding: '1.2rem', display: 'flex', gap: '1rem', alignItems: 'center', backgroundColor: 'var(--background-color, #1D2630)' }}>
              <div style={{ flex: 1, position: 'relative' }}>
                <input 
                  ...
                  style={{ width: '100%', padding: '0.8rem 0.8rem 0.8rem 2.5rem', borderRadius: '10px', border: '1px solid #0a3fff' }}
                />
              </div>
          ...
          <div className="contacts-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: '1.5rem' }}>
            {contactosFiltrados.map((contacto) => (
              <article key={contacto.id} className="benefit-box shadow-sm" style={{ textAlign: 'left', padding: '1.5rem', border: '1px solid #0a3fff', borderRadius: '12px'}}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                  <div style={{ 
                    width: '55px', height: '55px', backgroundColor: '#0a3fff', 
      ...
      {showModalBusqueda && (
        <div className="modal-overlay" style={{
          ...
          <div className="auth-card animated-glow" 
            style={{ width: '450px', 
                     padding: '2rem', 
            ...
            <h2 style={{ marginBottom: '0.5rem', textAlign: 'center' }}>Añadir por Directorio</h2>
            <p style={{ fontSize: '0.9rem', color: '#FFFF', marginBottom: '1.5rem', textAlign: 'center' }}>
              Ingresa el correo del usuario que deseas agregar a tu red segura.
            </p>
